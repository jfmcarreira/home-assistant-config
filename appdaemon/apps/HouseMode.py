...
class HouseMode(hass.Hass):
    ...
    def initialize(self):
        ...
        self.listen_state(self.light_callback_awake_up, "light.kitchen_group", new = "on", duration = 2*60 )
        self.listen_state(self.light_callback_awake_up, "light.living_room_group", new = "on", duration = 2*60 )
        self.listen_state(self.light_callback_awake_up, "light.office_group", new = "on", duration = 2*60 )
