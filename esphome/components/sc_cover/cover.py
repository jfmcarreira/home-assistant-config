...
from esphome.components import binary_sensor, cover, button
...
CONF_ACTIVATION_BUTTON = "activation_button"
...
CONFIG_SCHEMA = cover.COVER_SCHEMA.extend(
    {
        ...
        cv.Required(CONF_ACTIVATION_BUTTON): cv.use_id(button.Button),
...
async def to_code(config):
    ...
    bin = await cg.get_variable(config[CONF_ACTIVATION_BUTTON])
    cg.add(var.set_activation_button(bin))
